# ==========================================================================
# VERITAS & CROWN QA TEST SUITE — 9-STEP AUTOMATED AUDIT
# ==========================================================================
...
Write-Host "VERITAS & CROWN QA TEST SUITE - 9-STEP AUDIT" -ForegroundColor Cyan
Write-Host "======================================================" -ForegroundColor Cyan
...
Write-Host "`n--- Checking Section Header & Card Alignment ---" -ForegroundColor Yellow
...
if ($cssContent.Contains("@media (max-width: 1024px)") -and $cssContent.Contains(".nav-menu {")) {
  $passed.Add("style.css: @media (max-width: 1024px) breakpoint present with .nav-menu rule")
}
